...
<head>
    ...
    <title>GalinhaSos - Módulo Web / Informática</title>
    ...
    .page-item.active .page-link {
        z-index: 3;
        color: #ffffff;
        background-color: #e9864e;
        border-color: #e9864e;
    }

    .form-check-input:checked {
        background-color: #e9864e !important;
        border: 0;
    }
    ...
    .form-check-input:not(:disabled):not(.disabled):active:focus {
        ...
        outline: 0;
        border: 0;
        box-shadow: 0 0 0 0.1rem #e9864e !important;
    }
...
<body>
    <nav class="navbar sticky-top navbar-expand-md navbar-dark bg-custom">
        <div class="container-fluid">
            <a href="{{route('index')}}" class="navbar-brand d-flex align-items-center">
                <img src="{{asset('img/logoGalinhaSos.png')}}" width="80" height="80">
                <span class=" fw-bold bg-text text">GalinhaSos</span>
            </a>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="{{route('atividade.index')}}" class="dropdown-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#CD853F"
    ...
    <div class="container py-4">
        <div class="row">
            <div class="col-2">
                @if($menu == "admin")
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#CD853F" class="bi bi-gear-fill"
                    viewBox="0 0 16 16">
                    <path
                        d="M9.405 1.05c-.413-1.4-2.397-1.4-2.81 0l-.1.34a1.464 1.464 0 0 1-2.105.872l-.31-.17c-1.283-.698-2.686.705-1.987 1.987l.169.311c.446.82.023 1.841-.872 2.105l-.34.1c-1.4.413-1.4 2.397 0 2.81l.34.1a1.464 1.464 0 0 1 .872 2.105l-.17.31c-.698 1.283.705 2.686 1.987 1.987l.311-.169a1.464 1.464 0 0 1 2.105.872l.1.34c.413 1.4 2.397 1.4 2.81 0l.1-.34a1.464 1.464 0 0 1 2.105-.872l.31.17c1.283.698 2.686-.705 1.987-1.987l-.169-.311a1.464 1.464 0 0 1 .872-2.105l.34-.1c1.4-.413 1.4-2.397 0-2.81l-.34-.1a1.464 1.464 0 0 1-.872-2.105l.17-.31c.698-1.283-.705-2.686-1.987-1.987l-.311.169a1.464 1.464 0 0 1-2.105-.872l-.1-.34zM8 10.93a2.929 2.929 0 1 1 0-5.86 2.929 2.929 0 0 1 0 5.858z" />
                </svg>
                @else
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#CD853F"
            ...
            <div class="col-8 d-flex justify-content-center">
                <span class="text fs-4 fw-bold">{{ mb_strtoupper($submenu, 'UTF-8'); }}</span>
            </div>
...
<nav class="navbar fixed-bottom navbar-dark bg-success">
    <div class="container-fluid">
        <span class="text-white fw-light"><b>Projeto feito por:</b> <a
                class="link-warning link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover"
                href="https://www.instagram.com/eufelipecostaaa/?igshid=MmIzYWVlNDQ5Yg%3D%3D">Felipe Cardozo Costa</a> &
            <a class="link-warning link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover"
                href="https://www.instagram.com/mirelacostacunha/">Mirela Da Costa Cunha</a></span>
    </div>
</nav>
